...
class ADODB_Pager {
	...
	var $first = '<code><img src="../../views/png/next1.png" ></code>';
	var $prev = '<code><img src="../../views/png/next2.png" ></code>';
	var $next = '<code><img src="../../views/png/next3.png" ></code>';
	var $last = '<code><img src="../../views/png/next4.png" ></code>';
	var $moreLinks = '...';
	var $startLinks = '...';
	...
	function RenderLayout($header,$grid,$footer,$attributes="class='table table-striped'")
	{
